...
public class JwtUtils {
  ...
  public String generateJwtToken(Authentication authentication) {
    ...
    System.out.println("Username in token: " + userPrincipal.getUsername());
    System.out.println("Roles in token: " + userPrincipal.getAuthorities());
  ...
  public boolean validateJwtToken(String authToken) {
    try {
      // Print or log information for verification
